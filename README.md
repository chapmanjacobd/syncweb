...
The REPL provides interactive access to Syncthing API commands. Type `help` for available commands.

## Web UI

Syncweb includes a built-in web UI for managing your sync operations:
...
- `install.sh` - Install systemd service for syncweb-automatic
- `simple_wishlist.sh` - Simple wishlist generator
- `syncweb-wishlist.sh` - Wishlist script example
- `syncweb-blocklist.sh` - Blocklist script example
