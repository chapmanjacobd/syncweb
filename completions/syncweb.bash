_syncweb() {
    ...
    do
        case "${cmd},${i}" in
            ...
            syncweb,shutdown)
                ...
                ;;
            syncweb,snapshots)
                cmd="syncweb__subcmd__snapshots"
                ;;
            syncweb,sort)
            ...
            syncweb__subcmd__help,automatic)
                ...
                ;;
            syncweb__subcmd__help,backup)
                cmd="syncweb__subcmd__help__subcmd__backup"
                ;;
            ...
            syncweb__subcmd__help,report)
                ...
                ;;
            syncweb__subcmd__help,restore)
                cmd="syncweb__subcmd__help__subcmd__restore"
                ;;
            ...
            syncweb__subcmd__help,shutdown)
                ...
                ;;
            syncweb__subcmd__help,snapshots)
                cmd="syncweb__subcmd__help__subcmd__snapshots"
                ;;
            ...
            syncweb__subcmd__help__subcmd__link,revoke)
                ...
                ;;
            syncweb__subcmd__help__subcmd__mirror,add)
                cmd="syncweb__subcmd__help__subcmd__mirror__subcmd__add"
                ;;
            ...
            syncweb__subcmd__help__subcmd__network,test-relay)
                ...
                ;;
            syncweb__subcmd__help__subcmd__package,drop)
                cmd="syncweb__subcmd__help__subcmd__package__subcmd__drop"
                ;;
            ...
            syncweb__subcmd__help__subcmd__package,versions)
                ...
                ;;
            syncweb__subcmd__help__subcmd__package__subcmd__drop,export)
                cmd="syncweb__subcmd__help__subcmd__package__subcmd__drop__subcmd__export"
                ;;
            syncweb__subcmd__help__subcmd__package__subcmd__drop,import)
                cmd="syncweb__subcmd__help__subcmd__package__subcmd__drop__subcmd__import"
                ;;
            ...
            syncweb__subcmd__help__subcmd__schedule,set)
                ...
                ;;
            syncweb__subcmd__help__subcmd__snapshots,delete)
                cmd="syncweb__subcmd__help__subcmd__snapshots__subcmd__delete"
                ;;
            syncweb__subcmd__help__subcmd__snapshots,diff)
                cmd="syncweb__subcmd__help__subcmd__snapshots__subcmd__diff"
                ;;
            ...
            syncweb__subcmd__link__subcmd__help,revoke)
                ...
                ;;
            syncweb__subcmd__mirror,add)
                cmd="syncweb__subcmd__mirror__subcmd__add"
                ;;
            syncweb__subcmd__mirror,help)
                cmd="syncweb__subcmd__mirror__subcmd__help"
                ;;
            syncweb__subcmd__mirror__subcmd__help,add)
                cmd="syncweb__subcmd__mirror__subcmd__help__subcmd__add"
                ;;
            syncweb__subcmd__mirror__subcmd__help,help)
                cmd="syncweb__subcmd__mirror__subcmd__help__subcmd__help"
                ;;
            ...
            syncweb__subcmd__network__subcmd__help,test-relay)
                ...
                ;;
            syncweb__subcmd__package,drop)
                cmd="syncweb__subcmd__package__subcmd__drop"
                ;;
            ...
            syncweb__subcmd__package,versions)
                ...
                ;;
            syncweb__subcmd__package__subcmd__drop,export)
                cmd="syncweb__subcmd__package__subcmd__drop__subcmd__export"
                ;;
            syncweb__subcmd__package__subcmd__drop,help)
                cmd="syncweb__subcmd__package__subcmd__drop__subcmd__help"
                ;;
            syncweb__subcmd__package__subcmd__drop,import)
                cmd="syncweb__subcmd__package__subcmd__drop__subcmd__import"
                ;;
            syncweb__subcmd__package__subcmd__drop__subcmd__help,export)
                cmd="syncweb__subcmd__package__subcmd__drop__subcmd__help__subcmd__export"
                ;;
            syncweb__subcmd__package__subcmd__drop__subcmd__help,help)
                cmd="syncweb__subcmd__package__subcmd__drop__subcmd__help__subcmd__help"
                ;;
            syncweb__subcmd__package__subcmd__drop__subcmd__help,import)
                cmd="syncweb__subcmd__package__subcmd__drop__subcmd__help__subcmd__import"
                ;;
            syncweb__subcmd__package__subcmd__help,drop)
                cmd="syncweb__subcmd__package__subcmd__help__subcmd__drop"
                ;;
            ...
            syncweb__subcmd__package__subcmd__help,versions)
                ...
                ;;
            syncweb__subcmd__package__subcmd__help__subcmd__drop,export)
                cmd="syncweb__subcmd__package__subcmd__help__subcmd__drop__subcmd__export"
                ;;
            syncweb__subcmd__package__subcmd__help__subcmd__drop,import)
                cmd="syncweb__subcmd__package__subcmd__help__subcmd__drop__subcmd__import"
                ;;
            ...
            syncweb__subcmd__schedule__subcmd__help,set)
                ...
                ;;
            syncweb__subcmd__snapshots,delete)
                cmd="syncweb__subcmd__snapshots__subcmd__delete"
                ;;
            syncweb__subcmd__snapshots,diff)
                cmd="syncweb__subcmd__snapshots__subcmd__diff"
                ;;
            syncweb__subcmd__snapshots,help)
                cmd="syncweb__subcmd__snapshots__subcmd__help"
                ;;
            syncweb__subcmd__snapshots__subcmd__help,delete)
                cmd="syncweb__subcmd__snapshots__subcmd__help__subcmd__delete"
                ;;
            syncweb__subcmd__snapshots__subcmd__help,diff)
                cmd="syncweb__subcmd__snapshots__subcmd__help__subcmd__diff"
                ;;
            syncweb__subcmd__snapshots__subcmd__help,help)
                cmd="syncweb__subcmd__snapshots__subcmd__help__subcmd__help"
                ;;
    ...
    case "${cmd}" in
        syncweb)
            opts="-h --verbose --json --no-color --data-dir --help version repl start shutdown create join accept drop folders devices config ls find sort stat download import backup restore snapshots health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help"
        ...
        syncweb__subcmd__attest)
            opts="-h --license --provenance --derivative --sequence --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__automatic)
            opts="-h --show-filters --dry-run --paths --filters --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__backup)
            opts="-h --description --threads --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__collection)
            opts="-h --verbose --json --no-color --data-dir --help init add versions publish help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__collection__subcmd__init)
            opts="-h --version --name --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__collection__subcmd__publish)
            opts="-h --namespace --sequence --bootstrap --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__collection__subcmd__versions)
            opts="-h --version --changelog --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__completions)
            opts="-h --verbose --json --no-color --data-dir --help bash elvish fish powershell zsh"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__config)
            opts="-h --verbose --json --no-color --data-dir --help set show help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__create)
            opts="-h --mode --relay-fallback --network --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__download)
            opts="-h --max-peers --min-peers --min-count --max-count --threads --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__find)
            opts="-h --kind --max-depth --min-size --max-size --extension --type --threads --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__help)
            opts="version repl start shutdown create join accept drop folders devices config ls find sort stat download import backup restore snapshots health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__help__subcmd__automatic)
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__backup)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__help__subcmd__mirror)
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__mirror__subcmd__add)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__help__subcmd__package)
            opts="drop search info install upgrade remove verify list versions switch"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__package__subcmd__drop)
            opts="export import"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__package__subcmd__drop__subcmd__export)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__package__subcmd__drop__subcmd__import)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__help__subcmd__publish)
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__repl)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__help__subcmd__report)
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__restore)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__help__subcmd__shutdown)
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__snapshots)
            opts="diff delete"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__snapshots__subcmd__delete)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__help__subcmd__snapshots__subcmd__diff)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__import)
            opts="-h --folder --threads --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__indexing)
            opts="-h --verbose --json --no-color --data-dir --help enable disable publish search health meta filter help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__indexing__subcmd__filter)
            opts="-h --verbose --json --no-color --data-dir --help add subscribe help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__indexing__subcmd__filter__subcmd__add)
            opts="-h --verbose --json --no-color --data-dir --help device file hash"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__indexing__subcmd__meta)
            opts="-h --verbose --json --no-color --data-dir --help add help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__indexing__subcmd__meta__subcmd__add)
            opts="-h --sequence --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__indexing__subcmd__publish)
            opts="-h --catalog --tag --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__indexing__subcmd__search)
            opts="-h --limit --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__init)
            opts="-h --mode --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__link)
            opts="-h --verbose --json --no-color --data-dir --help create resolve revoke help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__link__subcmd__create)
            opts="-h --name --version --sequence --private --expires --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__link__subcmd__resolve)
            opts="-h --version --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__link__subcmd__revoke)
            ...
            ;;
        syncweb__subcmd__ls)
            opts="-h --sort --threads --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__mirror)
            ...
            return 0
            ;;
        syncweb__subcmd__mirror__subcmd__add)
            opts="-h --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__mirror__subcmd__help)
            opts="add help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__mirror__subcmd__help__subcmd__add)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__mirror__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__moderation)
            opts="-h --verbose --json --no-color --data-dir --help ls hide help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__moderation__subcmd__hide)
            opts="-h --reason --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__network)
            opts="-h --verbose --json --no-color --data-dir --help create ls join leave invite kick test-relay help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__network__subcmd__create)
            opts="-h --label --invite-only --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__network__subcmd__test__subcmd__relay)
            opts="-h --relay-url --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__package)
            opts="-h --verbose --json --no-color --data-dir --help drop search info install upgrade remove verify list versions switch help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__drop)
            opts="-h --verbose --json --no-color --data-dir --help export import help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__drop__subcmd__export)
            opts="-h --version --filter --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__drop__subcmd__help)
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__drop__subcmd__help__subcmd__export)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__drop__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__drop__subcmd__help__subcmd__import)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__drop__subcmd__import)
            opts="-h --filter --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__package__subcmd__help)
            opts="drop search info install upgrade remove verify list versions switch help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__help__subcmd__drop)
            opts="export import"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__help__subcmd__drop__subcmd__export)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__package__subcmd__help__subcmd__drop__subcmd__import)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__package__subcmd__info)
            opts="-h --ticket --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__package__subcmd__search)
            opts="-h --bootstrap --timeout-ms --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__publish)
            opts="-h --blob --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__schedule)
            opts="-h --verbose --json --no-color --data-dir --help set folder help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__schedule__subcmd__folder)
            opts="-h --active --max-upload --max-download --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__schedule__subcmd__set)
            opts="-h --active --bandwidth --period --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__shutdown)
            ...
            return 0
            ;;
        syncweb__subcmd__snapshots)
            opts="-h --verbose --json --no-color --data-dir --help diff delete help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__snapshots__subcmd__delete)
            opts="-h --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__snapshots__subcmd__diff)
            opts="-h --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__snapshots__subcmd__help)
            opts="diff delete help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        syncweb__subcmd__snapshots__subcmd__help__subcmd__delete)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__snapshots__subcmd__help__subcmd__diff)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        syncweb__subcmd__snapshots__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        syncweb__subcmd__sort)
            opts="-h --by --threads --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__stat)
            opts="-h --terse --format --threads --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__stats)
            opts="-h --folder --peer --reset --period --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__subscribe)
            opts="-h --ingest-only --ignore-self --prefix --glob --max-count --max-size --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__trust__subcmd__delegate)
            opts="-h --expires --scope --sequence --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        syncweb__subcmd__watch)
            opts="-h --debounce-ms --exclude --once --verbose --json --no-color --data-dir --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
