...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "version" -d 'Show syncweb version information'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "start" -d 'Start the local syncweb daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "shutdown" -d 'Stop the local syncweb node'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "status" -d 'Show the local daemon status'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "reload" -d 'Ask the local daemon to reload configuration'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "daemon-sync" -d 'Ask the local daemon to trigger synchronization'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "unwatch" -d 'Stop watching a folder for local changes'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "create" -d 'Create a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "join" -d 'Join a folder from an Iroh document ticket'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "leave" -d 'Leave and remove a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "unsubscribe" -d 'Unsubscribe from a folder\'s live sync loop'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "folders" -d 'List managed folders'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "devices" -d 'Show this device\'s Iroh and Syncthing identities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "config" -d 'Show or update local configuration'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "ls" -d 'List files in a local folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "find" -d 'Search local files'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "sort" -d 'Sort local files by discovery criteria'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "stat" -d 'Show detailed metadata for a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "download" -d 'Download folder content or copy a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "import" -d 'Import local files into a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "snapshot" -d 'Manage content-addressed snapshots'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "health" -d 'Show seeding status per folder blob'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "init" -d 'Initialize a folder and print a shareable URL'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "automatic" -d 'Run rules-based automatic synchronization'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "watch" -d 'Watch a folder and import filesystem changes'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "stats" -d 'Show persisted bandwidth accounting'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "filestats" -d 'Show file-level statistics for synced folder content'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "verify" -d 'Re-check local folder blob integrity'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "schedule" -d 'Show or update synchronization schedules'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "subscribe" -d 'Subscribe to a folder with event filters'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "publish" -d 'Publish a folder or blob for public read access'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "unpublish" -d 'Remove a public blob pin'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "collection" -d 'Create and publish versioned content collections'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "package" -d 'Manage locally installed collection packages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "network" -d 'Network connectivity utilities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "db" -d 'Database maintenance: check, vacuum, stats, backup'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "indexing" -d 'Manage opt-in indexing, catalogs, and metadata'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "link" -d 'Create and resolve stable syncweb links'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "mirror" -d 'Mirror all blobs from a provider or network'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "provider" -d 'Manage blob provider registrations'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "trust" -d 'Inspect and delegate local trust'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "attest" -d 'Sign content provenance attestations'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "moderation" -d 'Manage local moderation decisions'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "completions" -d 'Generate shell completions'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "manpages" -d 'Generate manpages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "media" -d 'Serve media blobs via HTTP (standalone media server)'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
