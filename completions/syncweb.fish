...
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -l no-daemon -l embedded -d 'Bypass the daemon and use an embedded node for supported commands'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "info" -d 'List durable transfer jobs'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "remaining" -d 'Show configured roots and remaining capacity'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "root" -d 'Add or update a materialization root'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "enqueue" -d 'Enqueue an individually addressable file job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "allocate" -d 'Allocate queued jobs to configured roots'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "materialize" -d 'Fetch and materialize assigned jobs through the daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "pause" -d 'Pause a transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "resume" -d 'Resume a paused transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "cancel" -d 'Cancel a transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "retry" -d 'Retry a failed transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and not __fish_seen_subcommand_from info remaining root enqueue allocate materialize pause resume cancel retry help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "info" -d 'List durable transfer jobs'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "remaining" -d 'Show configured roots and remaining capacity'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "root" -d 'Add or update a materialization root'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "enqueue" -d 'Enqueue an individually addressable file job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "allocate" -d 'Allocate queued jobs to configured roots'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "materialize" -d 'Fetch and materialize assigned jobs through the daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "pause" -d 'Pause a transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "resume" -d 'Resume a paused transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "cancel" -d 'Cancel a transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "retry" -d 'Retry a failed transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand transfer; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from export import search info install upgrade remove verify list versions switch help" -f -a "info" -d 'Show a collection manifest from a ticket or blob hash'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from export import search info install upgrade remove verify list versions switch help" -f -a "upgrade" -d 'Install a newer collection manifest version via ticket'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from export import search info install upgrade remove verify list versions switch help" -f -a "verify" -d 'Verify an installed collection version'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "info" -d 'Show a collection manifest from a ticket or blob hash'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "upgrade" -d 'Install a newer collection manifest version via ticket'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "verify" -d 'Verify an installed collection version'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -l no-daemon -l embedded -d 'Bypass the daemon and use an embedded node for supported commands'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "create" -d 'Create a named network'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "ls" -d 'List networks or inspect one'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "join" -d 'Join a network from an invitation'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "leave" -d 'Leave a network'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "invite" -d 'Generate a network invitation'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "kick" -d 'Remove a device from a network'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "events" -d 'Show recent network events'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "health" -d 'Show network connectivity health'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "test-relay" -d 'Test a Syncthing relay TCP connection'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and not __fish_seen_subcommand_from create ls join leave invite kick events health test-relay help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and __fish_seen_subcommand_from help" -f -a "events" -d 'Show recent network events'
complete -c syncweb -n "__fish_syncweb_using_subcommand network; and __fish_seen_subcommand_from help" -f -a "health" -d 'Show network connectivity health'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -l no-daemon -l embedded -d 'Bypass the daemon and use an embedded node for supported commands'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -f -a "check" -d 'Run integrity check on all databases'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -f -a "vacuum" -d 'Run VACUUM to reclaim space in all databases'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -f -a "stats" -d 'Show database sizes and table statistics'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -f -a "backup" -d 'Back up all databases to a directory'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and not __fish_seen_subcommand_from check vacuum stats backup help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and __fish_seen_subcommand_from help" -f -a "check" -d 'Run integrity check on all databases'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and __fish_seen_subcommand_from help" -f -a "vacuum" -d 'Run VACUUM to reclaim space in all databases'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and __fish_seen_subcommand_from help" -f -a "stats" -d 'Show database sizes and table statistics'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and __fish_seen_subcommand_from help" -f -a "backup" -d 'Back up all databases to a directory'
complete -c syncweb -n "__fish_syncweb_using_subcommand db; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand provider; and not __fish_seen_subcommand_from add help" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand provider; and not __fish_seen_subcommand_from add help" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand provider; and not __fish_seen_subcommand_from add help" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand provider; and not __fish_seen_subcommand_from add help" -l no-daemon -l embedded -d 'Bypass the daemon and use an embedded node for supported commands'
complete -c syncweb -n "__fish_syncweb_using_subcommand provider; and not __fish_seen_subcommand_from add help" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand provider; and not __fish_seen_subcommand_from add help" -f -a "add" -d 'Register a blob ticket as an alternate provider'
complete -c syncweb -n "__fish_syncweb_using_subcommand provider; and not __fish_seen_subcommand_from add help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -l no-daemon -l embedded -d 'Bypass the daemon and use an embedded node for supported commands'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -f -a "create" -d 'Sign and optionally broadcast a content attestation'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -f -a "verify" -d 'Verify attestations for content from the network'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and not __fish_seen_subcommand_from create verify help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and __fish_seen_subcommand_from help" -f -a "create" -d 'Sign and optionally broadcast a content attestation'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and __fish_seen_subcommand_from help" -f -a "verify" -d 'Verify attestations for content from the network'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -l no-daemon -l embedded -d 'Bypass the daemon and use an embedded node for supported commands'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -f -a "ls" -d 'List local moderation records'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -f -a "hide" -d 'Hide a content record locally'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -f -a "report" -d 'Sign and submit a moderation report (broadcasts via gossip)'
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide report help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and __fish_seen_subcommand_from help" -f -a "report" -d 'Sign and submit a moderation report (broadcasts via gossip)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "version" -d 'Show syncweb version information'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "start" -d 'Start the local syncweb daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "shutdown" -d 'Stop the local syncweb node'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "status" -d 'Show the local daemon status'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "reload" -d 'Ask the local daemon to reload configuration'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "daemon-sync" -d 'Ask the local daemon to trigger synchronization'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "unwatch" -d 'Stop watching a folder for local changes'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "create" -d 'Create a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "join" -d 'Join a folder from an Iroh document ticket'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "leave" -d 'Leave and remove a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "unsubscribe" -d 'Unsubscribe from a folder\'s live sync loop'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "folders" -d 'List managed folders'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "devices" -d 'Show this device\'s Iroh and Syncthing identities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "config" -d 'Show or update local configuration'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "ls" -d 'List files in a local folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "find" -d 'Search local files'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "sort" -d 'Sort local files by discovery criteria'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "stat" -d 'Show detailed metadata for a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "download" -d 'Download folder content or copy a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "import" -d 'Import local files into a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "snapshot" -d 'Manage content-addressed snapshots'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "health" -d 'Show seeding status per folder blob'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "transfer" -d 'Inspect and control durable transfer jobs'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "init" -d 'Initialize a folder and print a shareable URL'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "automatic" -d 'Run rules-based automatic synchronization'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "watch" -d 'Watch a folder and import filesystem changes'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "stats" -d 'Show persisted bandwidth accounting'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "filestats" -d 'Show file-level statistics for synced folder content'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "verify" -d 'Re-check local folder blob integrity'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "schedule" -d 'Show or update synchronization schedules'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "subscribe" -d 'Subscribe to a folder with event filters'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "publish" -d 'Publish a folder or blob for public read access'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "unpublish" -d 'Remove a public blob pin'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "collection" -d 'Create and publish versioned content collections'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "package" -d 'Manage locally installed collection packages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "network" -d 'Network connectivity utilities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "db" -d 'Database maintenance: check, vacuum, stats, backup'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "indexing" -d 'Manage opt-in indexing, catalogs, and metadata'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "link" -d 'Create and resolve stable syncweb links'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "mirror" -d 'Mirror all blobs from a provider or network'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "provider" -d 'Manage blob provider registrations'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "trust" -d 'Inspect and delegate local trust'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "attest" -d 'Sign content provenance attestations'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "moderation" -d 'Manage local moderation decisions'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "completions" -d 'Generate shell completions'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "manpages" -d 'Generate manpages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "media" -d 'Serve media blobs via HTTP (standalone media server)'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version start shutdown status reload daemon-sync unwatch create join leave unsubscribe folders devices config ls find sort stat download import snapshot health transfer init automatic watch stats filestats verify schedule subscribe publish unpublish collection package network db indexing link mirror provider trust attest moderation completions manpages media help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "info" -d 'List durable transfer jobs'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "remaining" -d 'Show configured roots and remaining capacity'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "root" -d 'Add or update a materialization root'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "enqueue" -d 'Enqueue an individually addressable file job'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "allocate" -d 'Allocate queued jobs to configured roots'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "materialize" -d 'Fetch and materialize assigned jobs through the daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "pause" -d 'Pause a transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "resume" -d 'Resume a paused transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "cancel" -d 'Cancel a transfer job'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from transfer" -f -a "retry" -d 'Retry a failed transfer job'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "info" -d 'Show a collection manifest from a ticket or blob hash'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "upgrade" -d 'Install a newer collection manifest version via ticket'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "verify" -d 'Verify an installed collection version'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from network" -f -a "events" -d 'Show recent network events'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from network" -f -a "health" -d 'Show network connectivity health'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from db" -f -a "check" -d 'Run integrity check on all databases'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from db" -f -a "vacuum" -d 'Run VACUUM to reclaim space in all databases'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from db" -f -a "stats" -d 'Show database sizes and table statistics'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from db" -f -a "backup" -d 'Back up all databases to a directory'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from attest" -f -a "create" -d 'Sign and optionally broadcast a content attestation'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from attest" -f -a "verify" -d 'Verify attestations for content from the network'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and __fish_seen_subcommand_from moderation" -f -a "report" -d 'Sign and submit a moderation report (broadcasts via gossip)'
