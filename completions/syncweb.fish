...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "search" -d 'List locally installed packages, optionally filtering by text'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "info" -d 'Show a collection manifest'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "install" -d 'Verify, stage, and atomically install a collection version'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "upgrade" -d 'Install a newer collection manifest version'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "remove" -d 'Remove a non-current installed collection version'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "verify" -d 'Verify an installed collection version against its manifest'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "list" -d 'List locally installed collections'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "versions" -d 'List installed versions for a collection'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "switch" -d 'Switch the active installed collection version'
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from search info install upgrade remove verify list versions switch help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "version" -d 'Show syncweb version information'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "repl" -d 'Start an interactive command shell'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "create" -d 'Create a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "join" -d 'Join a folder from an Iroh document ticket'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "accept" -d 'Accept a locally available folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "drop" -d 'Remove a local folder replica'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "folders" -d 'List managed folders'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "devices" -d 'Show this device\'s Iroh and Syncthing identities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "config" -d 'Show or update local configuration'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "ls" -d 'List files in a local folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "find" -d 'Search local files'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "sort" -d 'Sort local files by discovery criteria'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "stat" -d 'Show detailed metadata for a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "download" -d 'Download folder content or copy a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "backup" -d 'Create a content-addressed snapshot'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "restore" -d 'Restore a snapshot to a folder or directory'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "snapshots" -d 'List, diff, or delete snapshots'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "health" -d 'Show seeding status per folder blob'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "init" -d 'Initialize a folder and print a shareable URL'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "automatic" -d 'Run rules-based automatic synchronization'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "subscribe" -d 'Subscribe to a folder with event filters'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "publish" -d 'Publish a folder or blob for public read access'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "unpublish" -d 'Remove a public blob pin'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "collection" -d 'Create and publish versioned content collections'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "package" -d 'Manage locally installed collection packages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "network" -d 'Network connectivity utilities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "completions" -d 'Generate shell completions'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "manpages" -d 'Generate manpages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl create join accept drop folders devices config ls find sort stat download backup restore snapshots health init automatic subscribe publish unpublish collection package network completions manpages help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
