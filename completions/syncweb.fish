...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and __fish_seen_subcommand_from drop" -f -a "import" -d 'Import and install a compressed CAR drop file'
