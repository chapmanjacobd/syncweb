...
complete -c syncweb -n "__fish_syncweb_needs_command" -f -a "daemon" -d 'Start and manage the local syncweb daemon'
complete -c syncweb -n "__fish_syncweb_needs_command" -f -a "status" -d 'Show the local daemon status'
complete -c syncweb -n "__fish_syncweb_needs_command" -f -a "daemon-shutdown" -d 'Ask the local daemon to stop'
complete -c syncweb -n "__fish_syncweb_needs_command" -f -a "daemon-reload" -d 'Ask the local daemon to reload configuration'
complete -c syncweb -n "__fish_syncweb_needs_command" -f -a "daemon-sync" -d 'Ask the local daemon to trigger synchronization'
complete -c syncweb -n "__fish_syncweb_needs_command" -f -a "daemon-add" -d 'Add a folder to the running daemon'
complete -c syncweb -n "__fish_syncweb_needs_command" -f -a "daemon-remove" -d 'Remove a folder from the running daemon'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -l data-dir -d 'Override the global persistent data directory' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -l log-file -d 'Write daemon logs to this file' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -l max-threads -r
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -l sync-interval -r
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -s f -l foreground -d 'Run in the foreground'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -l no-color -d 'Disable colored output'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon" -s h -l help -d 'Print help'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand status" -l no-color -d 'Disable colored output'
complete -c syncweb -n "__fish_syncweb_using_subcommand status" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-shutdown" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-shutdown" -l force -d 'Skip graceful shutdown'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-shutdown" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-shutdown" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-shutdown" -l no-color -d 'Disable colored output'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-shutdown" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-reload" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-reload" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-reload" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-reload" -l no-color -d 'Disable colored output'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-reload" -s h -l help -d 'Print help'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-add" -l no-color -d 'Disable colored output'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-add" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-remove" -l data-dir -d 'Directory used for persistent node identity and data' -r -F
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-remove" -l verbose -d 'Enable verbose structured logging'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-remove" -l json -d 'Emit machine-readable JSON where supported'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-remove" -l no-color -d 'Disable colored output'
complete -c syncweb -n "__fish_syncweb_using_subcommand daemon-remove" -s h -l help -d 'Print help'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand leave" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand unsubscribe" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand snapshot; and not __fish_seen_subcommand_from create restore list diff delete help" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand snapshot; and __fish_seen_subcommand_from create" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand snapshot; and __fish_seen_subcommand_from restore" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand snapshot; and __fish_seen_subcommand_from list" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand snapshot; and __fish_seen_subcommand_from diff" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand snapshot; and __fish_seen_subcommand_from delete" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and not __fish_seen_subcommand_from export import search info install upgrade remove verify list versions switch help" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and __fish_seen_subcommand_from export" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand package; and __fish_seen_subcommand_from import" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and not __fish_seen_subcommand_from enable disable publish search health meta filter help" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and __fish_seen_subcommand_from enable" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and __fish_seen_subcommand_from disable" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and __fish_seen_subcommand_from publish" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and __fish_seen_subcommand_from search" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and __fish_seen_subcommand_from health" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and __fish_seen_subcommand_from meta" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand indexing; and __fish_seen_subcommand_from filter" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand link; and not __fish_seen_subcommand_from create resolve revoke help" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand link; and __fish_seen_subcommand_from create" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand link; and __fish_seen_subcommand_from resolve" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand link; and __fish_seen_subcommand_from revoke" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand mirror; and not __fish_seen_subcommand_from add help" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand mirror; and __fish_seen_subcommand_from add" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand trust; and not __fish_seen_subcommand_from show delegate provider stream help" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand trust; and __fish_seen_subcommand_from show" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand trust; and __fish_seen_subcommand_from delegate" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand trust; and __fish_seen_subcommand_from provider" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand trust; and __fish_seen_subcommand_from stream" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand attest" -l provenance -r
complete -c syncweb -n "__fish_syncweb_using_subcommand attest" -l derivative -r
...
complete -c syncweb -n "__fish_syncweb_using_subcommand attest" -l no-color -d 'Disable colored output'
complete -c syncweb -n "__fish_syncweb_using_subcommand attest" -s h -l help -d 'Print help'
complete -c syncweb -n "__fish_syncweb_using_subcommand report" -l reason -r
...
complete -c syncweb -n "__fish_syncweb_using_subcommand report" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and not __fish_seen_subcommand_from ls hide help" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and __fish_seen_subcommand_from ls" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand moderation; and __fish_seen_subcommand_from hide" -l no-color -d 'Disable colored output'
...
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "version" -d 'Show syncweb version information'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "repl" -d 'Start an interactive command shell'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "start" -d 'Start the local syncweb node for one command invocation'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "shutdown" -d 'Stop the local syncweb node'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "daemon" -d 'Start and manage the local syncweb daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "status" -d 'Show the local daemon status'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "daemon-shutdown" -d 'Ask the local daemon to stop'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "daemon-reload" -d 'Ask the local daemon to reload configuration'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "daemon-sync" -d 'Ask the local daemon to trigger synchronization'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "daemon-add" -d 'Add a folder to the running daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "daemon-remove" -d 'Remove a folder from the running daemon'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "create" -d 'Create a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "join" -d 'Join a folder from an Iroh document ticket'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "leave" -d 'Leave and remove a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "unsubscribe" -d 'Unsubscribe from a folder\'s live sync loop'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "folders" -d 'List managed folders'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "devices" -d 'Show this device\'s Iroh and Syncthing identities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "config" -d 'Show or update local configuration'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "ls" -d 'List files in a local folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "find" -d 'Search local files'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "sort" -d 'Sort local files by discovery criteria'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "stat" -d 'Show detailed metadata for a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "download" -d 'Download folder content or copy a local file'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "import" -d 'Import local files into a synchronized folder'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "snapshot" -d 'Manage content-addressed snapshots'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "health" -d 'Show seeding status per folder blob'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "init" -d 'Initialize a folder and print a shareable URL'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "automatic" -d 'Run rules-based automatic synchronization'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "watch" -d 'Watch a folder and import filesystem changes'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "stats" -d 'Show persisted bandwidth accounting'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "verify" -d 'Re-check local folder blob integrity'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "schedule" -d 'Show or update synchronization schedules'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "subscribe" -d 'Subscribe to a folder with event filters'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "publish" -d 'Publish a folder or blob for public read access'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "unpublish" -d 'Remove a public blob pin'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "collection" -d 'Create and publish versioned content collections'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "package" -d 'Manage locally installed collection packages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "network" -d 'Network connectivity utilities'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "indexing" -d 'Manage opt-in indexing, catalogs, and metadata'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "link" -d 'Create and resolve stable syncweb links'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "mirror" -d 'Register alternate content providers'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "trust" -d 'Inspect and delegate local trust'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "attest" -d 'Sign content provenance attestations'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "report" -d 'Submit a local moderation report'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "moderation" -d 'Manage local moderation decisions'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "completions" -d 'Generate shell completions'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "manpages" -d 'Generate manpages'
complete -c syncweb -n "__fish_syncweb_using_subcommand help; and not __fish_seen_subcommand_from version repl start shutdown daemon status daemon-shutdown daemon-reload daemon-sync daemon-add daemon-remove create join leave unsubscribe folders devices config ls find sort stat download import snapshot health init automatic watch stats verify schedule subscribe publish unpublish collection package network indexing link mirror trust attest report moderation completions manpages help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
